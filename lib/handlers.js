...
import { getAudio } from './soundVisualizer';
...
function handleError(err) {
  console.log(
    'You must give access to your mic for the audio visualizer to work.'
  );
}
...
export async function startGame() {
  ...
  // get audio viz stream
  // prompt the user for permission for audio input
